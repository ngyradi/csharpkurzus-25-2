...
namespace Todo.UI
{
    ...
    {
        public static ICharacterView CreateView(InputMode inputMode, ITodoManager manager, IViewUtils viewUtils, ICharacterDisplay characterDisplay)
        {
            return inputMode switch
            {
                InputMode.None => new DefaultView(manager, viewUtils, characterDisplay),
